function fh = plotProj(proj,varargin)
% PLOTPROJ plots the projection data
% 
%   PLOTPROJ(PROJ) plots projection data PROJ with the increase of camera
%                   number
% 
%   PLOTPROJ(PROJ,OPTS,VAL,...) Allows user specified OPTS options
...
%--------------------------------------------------------------------------
%% Parse inputs
opts=     {'step','colormap','clims','savegif','slice','figure_flag'};
