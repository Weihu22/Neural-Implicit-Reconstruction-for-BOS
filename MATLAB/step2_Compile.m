...
% This file will compile all the necesary mex files for BOSLAB to work. You
...
if contains(computer('arch'),'64')    
    mex('-g','-largeArrayDims', './Utilities/cuda_interface/Ax_mex.cpp',  '../Common/CUDA/GpuIds.cpp','../Common/CUDA/BOSLAB_common.cpp','../Common/CUDA/BOSLAB_common.cu','../Common/CUDA/ray_interpolated_projection.cu','../Common/CUDA/Siddon_projection.cu', '-outdir', outdir, FLAGS)
    mex('-g','-largeArrayDims', './Utilities/cuda_interface/Atb_mex.cpp',  '../Common/CUDA/GpuIds.cpp','../Common/CUDA/BOSLAB_common.cpp','../Common/CUDA/BOSLAB_common.cu','../Common/CUDA/voxel_backprojection.cu', '-outdir', outdir, FLAGS)
    mex('-g','-largeArrayDims', './Utilities/GPU/getGpuName_mex.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
    mex('-g','-largeArrayDims', './Utilities/GPU/getGpuCount_mex.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)

else    
   mex('-g', './Utilities/cuda_interface/Ax_mex.cpp','../Common/CUDA/ray_interpolated_projection.cu','../Common/CUDA/Siddon_projection.cu', '../Common/CUDA/BOSLAB_common.cu', '../Common/CUDA/GpuIds.cpp', '-outdir', outdir, FLAGS)
   mex('-g', './Utilities/cuda_interface/Atb_mex.cpp',  '../Common/CUDA/GpuIds.cpp','../Common/CUDA/BOSLAB_common.cpp','../Common/CUDA/BOSLAB_common.cu','../Common/CUDA/voxel_backprojection.cu', '-outdir', outdir, FLAGS)
   mex('-g', './Utilities/GPU/getGpuName_mex.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
   mex('-g','./Utilities/GPU/getGpuCount_mex.cpp', '../Common/CUDA/gpuUtils.cu', '-outdir', outdir, FLAGS)
